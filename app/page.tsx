...
/*
  The home / "start here" screen, reachable from the sidebar. Signing in lands on
  the Dashboard instead (see components/AuthGate.tsx), so this page is now a
  reference for what the app covers rather than the first thing anyone sees.
*/
