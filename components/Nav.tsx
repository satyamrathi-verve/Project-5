...
export const NAV_SECTIONS: NavSection[] = [
  ...
  },
  {
    ...
    links: [
      ...
      { href: "/invoices/print", label: "Invoice Print", icon: "file", built: true, moduleKey: "invoices" },
...
export function Sidebar({
  ...
  return (
    <>
      ...
      <aside
        className={`fixed inset-y-0 left-0 z-[4001] flex flex-col bg-gradient-to-b from-slate-900 via-slate-900 to-teal-950 text-slate-300 shadow-xl transition-[width,transform] duration-200 ease-out print:hidden lg:static lg:z-auto lg:translate-x-0 ${
